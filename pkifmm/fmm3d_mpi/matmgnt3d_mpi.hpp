...
public:
  ...
  fftw_plan density_forplan;
  fftw_plan density_invplan;
  bool built_density_forplan;
  bool built_density_invplan;
  fftw_plan operator_forplan;
  bool built_operator_forplan;
...
public:
  ...
  int UpwChk2UpwEqu_mat(int level);
  ...
  int UpwEqu2DwnChk_mat(int level);
